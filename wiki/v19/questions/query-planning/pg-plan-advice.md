...
The feature's visible module landed in 27 commits that touched `contrib/pg_plan_advice/` (2026-03-12 through 2026-08-15), but the complete scoped source history also includes 20 core planner foundation/enabling/fix commits and test/doc support commits. Those are separated under [Source Commit History](#source-commit-history).
...
The 27 direct module commits are:
