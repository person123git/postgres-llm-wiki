...
- [Usage of NUM_BUFFER_PARTITIONS in PostgreSQL 18 (unverified)](questions/num-buffer-partitions.md) - How PostgreSQL 18 uses the fixed `NUM_BUFFER_PARTITIONS` count for shared buffer mapping hash partitions, `BufferMapping` LWLocks, read/allocation, extension, and invalidation paths.
