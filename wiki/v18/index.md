...
- [[v18/questions/explain-analyze-buffers-output|EXPLAIN ANALYZE BUFFERS Output in PostgreSQL 18 (unverified)]] - Detailed explanation of shared, local, temp, planning, serialization, parallel-worker, and I/O timing fields in `EXPLAIN (ANALYZE, BUFFERS)` output.
