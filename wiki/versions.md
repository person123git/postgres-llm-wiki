...
- 2026-08-13: removed the v12 question page Detecting Bloat in All Index Types
  ...
  through
  [Measuring B-Tree Index Bloat With Core SQL Only in PostgreSQL 12 (unverified)](v12/questions/indexing/btree-index-bloat-core-sql-only.md).
  The separate v17 page
  [Detecting Bloat in All Index Types by Storing an Index/Heap Size Ratio in COMMENT in PostgreSQL 17 (unverified)](v17/questions/indexing/comment-stored-index-heap-ratio-bloat.md)
  and its inbound links are untouched, so v17 still carries this proposal. The
